	    ...
	    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
		    <div class="d-flex flex-column align-content-end">
			        ...
			        <div class="auth-form-container text-start">
						...
						<form class="auth-form login-form" method="POST" action="{{ route('login') }}">
							...
							<div class="email mb-3">
								...
								<input id="signin-email" name="email" type="email" class="form-control signin-email" placeholder="Adresse email" required="required" value="{{ old('email') }}">
								@error('email')
						...
						<div class="auth-option text-center pt-5">Pas encore de compte ? <a class="text-link" href="#">Inscrivez-vous ici</a>.</div>
			    ...
			    <footer class="app-auth-footer">
			        ...
			        <small class="copyright">Développé par <i class="fas fa-heart" style="color: #fb866a;"></i> Mentley & Partners</small>
				    </div>
