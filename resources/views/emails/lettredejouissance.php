...
<head>
    ...
    <title>Notification Générale de Jouissance de Congé</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        ...
        <p>
            Pour toute question concernant la gestion de vos congés, merci de contacter directement votre manager ou le Département des Ressources Humaines via le portail dédié.
        </p>

        <p>
            Nous comptons sur votre coopération pour assurer le bon déroulement de la planification des congés, garantissant ainsi l'équilibre entre les besoins opérationnels de l'entreprise et le bien-être du personnel.
        </p>
    </div>
